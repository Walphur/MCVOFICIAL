...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "players.heroLead": "Nombre y avatar de Steam en vivo: aparecés en la grilla cuando vinculás tu cuenta.",
            "players.ctaDiscord": "Discord",
            "players.ctaEvents": "Torneos",
            "players.ctaMemberProfile": "Cargar mi perfil",
            "players.teamCardExplain": "Esta grilla es <strong>solo el wipe</strong> (Steam vía Discord). Tu card con nombre y redes para la web del clan se pide con el botón de arriba; el staff la aprueba y aparece en la página <a href=\"equipo.html\">Equipo</a>.",
            "players.hintSlash": "En Discord usá <code>/mcv-wipe</code> y pegá tu SteamID64 (17 dígitos).",
            "players.detailsSummary": "Avanzado: Hexaytron, staff e importación",
            "players.hintAdvanced": "En el canal configurado podés usar <code>!mcvsteam</code> con tu SteamID64. Mismo bot MCV: invitalo al servidor del clan; si hace falta, <code>DISCORD_WIPE_GUILD_ID</code> = ID del servidor donde querés <code>/mcv-wipe</code>.",
            "players.bulkStaffHint": "<strong>Staff</strong> (sin depender del bot): <a href=\"login.html\">login admin</a> → <strong>Torneos</strong> → «Lista wipe» → pegá SteamID64 → <em>Importar / fusionar</em>. Opcional en servidor: <code>MCV_WIPE_IMPORT_STEAMS</code> (al arrancar).",
            "players.creatorTitle": "Creador / admin MCV",
            "players.cardWipeList": "Lista wipe",
            "players.cardViaHex": "Registro vía Discord",
            ...
            "team.heroLead": "Quienes representan y crean contenido con el clan. Los perfiles se publican cuando el staff aprueba tu envío.",
            "team.sectionRoster": "En la web",
            "team.rosterEmpty": "Todavía no hay perfiles publicados.",
            "team.sectionForm": "Sumá tu perfil",
            "team.formIntro": "Completá el formulario. Solo se muestran links que pegues; el staff revisa antes de publicar.",
            ...
            "team.phSteam": "76561198… o URL de Steam",
            "team.fieldX": "X / Twitter",
            "team.formHintRequired": "* Obligatorio: nombre visible y al menos Steam o un link https válido.",
            ...
            "admin.teamWebTitle": "Solicitudes equipo (equipo.html)",
            "admin.teamWebHint": "Los envíos desde la web quedan en pendiente hasta que apruebes o rechaces. Solo los aprobados se ven en la grilla pública.",
        ...
        en: {
            ...
            "players.heroLead": "Live Steam name and avatar: link your account and you appear in the grid.",
            "players.ctaDiscord": "Discord",
            "players.ctaEvents": "Tournaments",
            "players.ctaMemberProfile": "Add my profile",
            "players.teamCardExplain": "This grid is <strong>wipe roster only</strong> (Steam via Discord). Your name and social links for the clan site are submitted with the button above; staff approves them and they show on the <a href=\"equipo.html\">Team</a> page.",
            "players.hintSlash": "In Discord use <code>/mcv-wipe</code> and paste your 17-digit SteamID64.",
            "players.detailsSummary": "Advanced: Hexaytron, staff, import",
            "players.hintAdvanced": "In the configured channel you can send <code>!mcvsteam</code> with your SteamID64. Same MCV bot: invite it to your clan server; if needed set <code>DISCORD_WIPE_GUILD_ID</code> to that server’s ID for <code>/mcv-wipe</code>.",
            "players.bulkStaffHint": "<strong>Staff</strong> (without the bot): <a href=\"login.html\">admin login</a> → <strong>Tournaments</strong> → “Wipe list” → paste SteamID64 → <em>Import / merge</em>. Optional on the server: <code>MCV_WIPE_IMPORT_STEAMS</code> (on boot).",
            "players.creatorTitle": "MCV creator / admin",
            "players.cardWipeList": "Wipe roster",
            "players.cardViaHex": "Via Discord",
            ...
            "team.heroLead": "People who represent MCV and create content. Profiles go live after staff approves your submission.",
            "team.sectionRoster": "On the site",
            "team.rosterEmpty": "No public profiles yet.",
            "team.sectionForm": "Add your profile",
            "team.formIntro": "Fill the form. Only links you paste are shown; staff reviews before publishing.",
            ...
            "team.phSteam": "76561198… or Steam profile URL",
            "team.fieldX": "X / Twitter",
            "team.formHintRequired": "* Required: display name and at least Steam or one valid https link.",
            ...
            "admin.teamWebTitle": "Team profile requests (equipo.html)",
            "admin.teamWebHint": "Submissions stay pending until you approve or reject. Only approved profiles appear on the public grid.",
