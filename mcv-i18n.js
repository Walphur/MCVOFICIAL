...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "team.heroLead": "Roster público de miembros: nombre visible, función en el clan y enlaces a Steam y redes autorizados. Los perfiles se publican tras revisión del staff.",
            ...
            "team.formIntroWipe": "Completá el formulario con su nombre público, identificador Steam y, si corresponde, enlaces HTTPS a sus canales. Las solicitudes se gestionan desde el panel en <strong>Perfiles equipo</strong> y requieren aprobación antes de mostrarse en esta página.",
            ...
            "admin.teamWebHint": "Gestioná las fichas del clan: aprobar, rechazar o editar links cuando alguien te pase una red nueva. Solo las aprobadas se muestran arriba en la página Equipo.",
        ...
        en: {
            ...
            "team.heroLead": "Official public roster: display name, clan role and authorized links to Steam and social channels. Profiles are published after staff review.",
            "team.sectionRoster": "On the site",
            "team.rosterEmpty": "No published profiles at this time.",
            "team.sectionForm": "Profile request",
            "team.formIntroWipe": "Provide your public display name, Steam identifier and, where applicable, HTTPS links to your channels. Requests are handled in the admin <strong>Team profiles</strong> tab and require approval before appearing on this page.",
            ...
            "admin.teamWebHint": "Manage clan cards: approve, reject, or edit links when someone sends you a new URL. Only approved profiles appear on the public Team page.",
