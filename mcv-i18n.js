...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "tournament.regExpiredHtml": "El plazo de inscripción terminó el <strong>{date}</strong>. Seguinos en <a href=\"events.html\">Torneos</a> o en Discord.",
            ...
            "admin.vitalIntro": "Cruzá las stats de los servidores Vital con el roster MCV (lista wipe + perfiles aprobados). Solo admins; el backend hace de proxy con caché — <strong>no</strong> uses scraping del sitio. Configurá las URLs de la API en Render (<code>VITAL_API_*</code>); los admins de Vital avisan que la API puede cambiar sin aviso.",
            ...
            "admin.vitalAllFound": "Todos los del roster tienen fila en la tabla.",
        ...
        en: {
            ...
            "tournament.regExpiredHtml": "Registration closed on <strong>{date}</strong>. Follow <a href=\"events.html\">Tournaments</a> or Discord.",
            ...
            "admin.vitalIntro": "Cross-check Vital server stats with the MCV roster (wipe list + approved profiles). Admins only; the backend proxies with cache — do <strong>not</strong> scrape their website. Set API URLs on Render (<code>VITAL_API_*</code>); Vital warns the API may change without notice.",
            ...
            "admin.vitalAllFound": "Everyone in the roster has a row in the table.",
