...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "team.heroLead": "Perfiles del clan con nombre y redes. El staff aprueba cada ficha antes de que aparezca arriba. El formulario está oculto hasta que abras «Cargar / actualizar mi ficha».",
            "team.sectionRoster": "En la web",
            "team.rosterEmpty": "Todavía no hay perfiles publicados.",
            "team.sectionForm": "Tu ficha en la web",
            "team.formIntroWipe": "Enviá tu solicitud; un admin la revisa en el panel (pestaña <strong>Perfiles equipo</strong>). No hace falta estar en la lista automática del wipe: con aprobar alcanza para publicarte.",
        ...
        en: {
            ...
            "team.heroLead": "Clan profiles with name and social links. Staff approves each card before it appears above. The form stays hidden until you open “Add / update my card”.",
            "team.sectionRoster": "On the site",
            "team.rosterEmpty": "No public profiles yet.",
            "team.sectionForm": "Your card on the site",
            "team.formIntroWipe": "Submit a request; an admin reviews it in the panel (<strong>Team profiles</strong> tab). You don’t need to be on the automatic wipe list—approval is enough to go live.",
