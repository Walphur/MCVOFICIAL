...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "team.heroLead": "Primero entrá al roster del wipe con <code>/mcv-wipe</code> en Discord. Después abrí «Cargar / actualizar mi ficha» y completá tus redes; el staff aprueba y acá se publica.",
            "team.sectionRoster": "En la web",
            "team.rosterEmpty": "Todavía no hay perfiles publicados.",
            "team.sectionForm": "Tu ficha en la web",
            "team.formIntroWipe": "Solo quien ya está en el <strong>roster del wipe</strong> puede enviar el formulario: el servidor comprueba tu SteamID64 contra la lista del wipe. El formulario no se muestra hasta que toques el botón de abajo.",
            ...
            "team.fieldSteamWipe": "SteamID64 del wipe *",
            "team.phSteamWipe": "Los mismos 17 dígitos que con /mcv-wipe, o link …/profiles/765… (también /profile/765…)",
            "team.fieldX": "X / Twitter",
            "team.formHintWipe": "* Obligatorio: nombre visible y Steam del wipe. Los links son opcionales; solo se muestran los que pegues con <code>https://</code>.",
        ...
        en: {
            ...
            "team.heroLead": "First join the wipe roster with <code>/mcv-wipe</code> on Discord. Then open “Add / update my card” and add your social links; staff approves and it shows here.",
            "team.sectionRoster": "On the site",
            "team.rosterEmpty": "No public profiles yet.",
            "team.sectionForm": "Your card on the site",
            "team.formIntroWipe": "Only players already on the <strong>wipe roster</strong> can submit: the server checks your SteamID64 against the wipe list. The form stays hidden until you tap the control below.",
            ...
            "team.fieldSteamWipe": "Wipe roster SteamID64 *",
            "team.phSteamWipe": "Same 17 digits as /mcv-wipe, or …/profiles/765… (also /profile/765…)",
            "team.fieldX": "X / Twitter",
            "team.formHintWipe": "* Required: display name and wipe Steam. Social links are optional; only pasted <code>https://</code> URLs are shown.",
