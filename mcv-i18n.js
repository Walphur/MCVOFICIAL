...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "admin.formFinishHint": "Cierra el torneo seleccionado arriba. Podés subir imagen (máx 5MB) o dejar vacío. Con la casilla marcada se borran todas las inscripciones y el bracket; el nombre del campeón y el póster quedan en la ficha pública.",
            "admin.formFinishHint2": "Cambiar estado sin finalizar: usá PATCH desde consola o añadimos toggles después.",
        ...
        en: {
            ...
            "admin.formFinishHint": "Closes the tournament selected above. You can upload an image (max 5MB) or leave empty. If checked, all signups and bracket are cleared; champion name and poster stay on the public page.",
            "admin.formFinishHint2": "Change status without finishing: use PATCH from console or we add toggles later.",
