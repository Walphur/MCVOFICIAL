...
(function (w) {
    ...
    var DICT = {
        es: {
            ...
            "home.strip1": "Red MCV",
            "team.heroTag": "// MCV · Faces",
            "team.heroTitle": "Nuestro",
            "team.heroTitleSpan": "equipo.",
            "team.heroLead": "Somos MCV: Rust, torneos y comunidad. Acá ves a quienes representan al clan en redes y Steam.",
            "team.sectionRoster": "En la web",
            "team.rosterEmpty": "Todavía no hay perfiles publicados.",
            "team.sectionForm": "Tu ficha MCV",
            "team.formIntroWipe": "Pedí tu lugar en la grilla del clan: nombre, Steam y las redes que quieras mostrar. El staff lo revisa en <strong>Perfiles equipo</strong> del panel antes de publicarlo.",
            "team.formToggle": "Cargar / actualizar mi ficha",
            "team.fieldDisplayName": "Nombre en la página *",
            "team.phDisplayName": "Cómo querés aparecer",
            "team.fieldRole": "Rol o descripción corta (opcional)",
            "team.phRole": "Ej. Content creator, Staff",
            "team.fieldSteam": "SteamID64 o link de perfil (opcional si pegás redes)",
            "team.phSteam": "76561198… o …/profiles/765… (recomendado para foto en la card)",
            "team.fieldX": "X / Twitter",
            "team.formHintWipe": "* Obligatorio: nombre visible y al menos <strong>Steam o un link https</strong> de red social. Solo se muestran los links que pegues.",
            "team.formSubmit": "Enviar solicitud",
            "team.formSuccess": "Listo: recibimos tu perfil. Cuando un admin lo apruebe, vas a aparecer arriba.",
            "team.formError": "No se pudo enviar. Revisá los datos o probá más tarde.",
            "team.formNetwork": "Error de red. Comprobá conexión y la URL del API.",
            "team.loadError": "No se pudo cargar el equipo. Comprobá que el API esté en línea.",
        ...
        en: {
            ...
            "team.heroLead": "We are MCV: Rust, tournaments, and community. Here you’ll see who represents the clan on socials and Steam.",
            "team.sectionRoster": "On the site",
            "team.rosterEmpty": "No public profiles yet.",
            "team.sectionForm": "Your MCV card",
            "team.formIntroWipe": "Request your spot on the clan grid: name, Steam, and the links you want shown. Staff reviews it in the <strong>Team profiles</strong> admin tab before it goes live.",
            "team.formToggle": "Add / update my card",
            "team.fieldDisplayName": "Display name *",
            "team.phDisplayName": "How you want to appear",
            ...
            "team.phSteam": "76561198… or …/profiles/765… (recommended for avatar on the card)",
            "team.fieldX": "X / Twitter",
            "team.formHintWipe": "* Required: display name and at least <strong>Steam or one https</strong> social link. Only pasted URLs are shown.",
            "team.formSubmit": "Submit request",
            "team.formSuccess": "Received. When an admin approves it, you will appear above.",
            "team.formError": "Could not submit. Check your data or try again later.",
            "team.formNetwork": "Network error. Check connection and API URL.",
            "team.loadError": "Could not load team profiles. Check that the API is online.",
